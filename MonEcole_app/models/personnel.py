...
class Personnel(models.Model):
    ...
    identiteUrl = models.CharField(max_length=255, null=True, blank=True)
    id_posteAdministratif = models.IntegerField(null=True, blank=True)
    id_tache = models.IntegerField(null=True, blank=True)
