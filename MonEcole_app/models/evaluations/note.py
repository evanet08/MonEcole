...
class Deliberation_annuelle_finalite(models.Model):
    ...
    class Meta:
        ...
        # verbose_name_plural = "Finalités de délibération annuelle"
    def __str__(self):
...
class Deliberation_annuelle_condition(models.Model):
    ...
    id_mention = models.ForeignKey(Mention,on_delete = models.PROTECT,null=False )   
    ...
    class Meta:
        ...
        # verbose_name_plural = "Conditions de délibération annuelle"

    def __str__(self):
        return f"{self.id_mention} - {self.id_finalite}"
...
class Deliberation_annuelle_resultat(models.Model):
    ...
    id_mention = models.ForeignKey(Mention,on_delete = models.PROTECT,null=False ) 
    id_decision = models.ForeignKey(Deliberation_annuelle_condition,on_delete=models.PROTECT,null=False) 
    ...
    class Meta:
        ...
        # verbose_name_plural = "Résultats de délibération annuelle"
...
class Deliberation_periodique_resultat(models.Model):
    ...
    class Meta:
        ...
        # verbose_name_plural = "Résultats de délibération périodique"
...
class Deliberation_trimistrielle_resultat(models.Model):
    ...
    class Meta:
        ...
        # verbose_name_plural = "Résultats de délibération trimestrielle"
