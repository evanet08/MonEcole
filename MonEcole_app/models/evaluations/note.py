...
class Deliberation_annuelle_condition(models.Model):
    ...
    id_cycle_id = models.IntegerField(null=False, db_column='id_cycle_id')
    id_classe_id = models.IntegerField(null=False, db_column='id_classe_id')
...
class Deliberation_annuelle_resultat(models.Model):
    ...
    id_cycle_id = models.IntegerField(null=True, blank=True, db_column='id_cycle_id') 
    id_classe_id = models.IntegerField(null=True, blank=True, db_column='id_classe_id')
...
class Evaluation(models.Model):
    ...
    id_cycle_actif_id = models.IntegerField(null=True, blank=True, db_column='id_cycle_actif_id')
    id_classe_active_id = models.IntegerField(null=True, blank=True, db_column='id_classe_active_id')   
