...
from MonEcole_app.models import Campus,Annee_trimestre,Classe_active,Annee
...
def create_footer__secondaire_rdc(elements, style_normal, style_center, classe_id):
    ...
    classe_obj = Classe_active.objects.filter(id_classe_active=classe_id).first()
    if classe_obj:
        classe_id_obj = classe_obj.classe_id
        classe_name = classe_id_obj.classe if classe_id_obj else ""
